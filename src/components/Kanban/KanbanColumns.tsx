...
const KanbanColumns = ({column,cards}:ColumnProps) => {
    ...
    <>
        ...
        <div ref={setNodeRef} className='relative h-full w-78 flex-shrink-0'>
            {showAddCard && createPortal(
                        <div ref={popupRef} className='absolute top-[30%] transform translate-x-[-50%] translate-y-[-50%] w-100 h-70 left-[50%] z-[11]'>
